        ...
        <div className="flex min-h-screen flex-col">
            <div className="flex flex-1">
                <aside className="w-56 bg-gray-900 border-r border-gray-700 flex flex-col p-4 gap-2 sticky top-[93px] h-[calc(100vh-93px)] overflow-y-auto">
                    <AdminSidebarLink href="/applicant/dashboard" label="Mi Actividad" />
                    <AdminSidebarLink href="/applicant/dashboard/applications" label="Mis Postulaciones" />
                    <AdminSidebarLink href="/applicant/dashboard/feedbacks" label="Feedbacks Recibidos" />
                </aside>
